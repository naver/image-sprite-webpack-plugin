declare module 'css' {
    ...
    export function parse(css: string, options?: ParseOptions): import('./types').CssStylesheet;
    export function stringify(stylesheet: import('./types').CssStylesheet, options?: StringifyOptions): string;
}
