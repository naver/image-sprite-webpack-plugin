...
describe('Sprite Generation Integration', () => {
  ...
  describe('simple fixture (style-loader)', () => {
    const configPath = path.resolve(
      __dirname,
      '../__fixtures__/simple/webpack.config.js',
    )
    ...
    test('should generate sprite image', async () => {
      ...
      expect(
        spriteFiles.some(f => f.startsWith('sprite-') && f.endsWith('.png')),
      ).toBe(true)
    })
  ...
  describe('mini-css-extract fixture', () => {
    const configPath = path.resolve(
      __dirname,
      '../__fixtures__/mini-css-extract/webpack.config.js',
    )
    ...
    test('should generate sprite image', async () => {
      ...
      const distPath = path.resolve(
        __dirname,
        '../__fixtures__/mini-css-extract/dist',
      )
      const spritePath = path.join(distPath, 'sprite')
